...
export default function MentorSessionRoom() {
  ...
  const handleEndSession = async () => {
    if (
      !window.confirm(
        "Mark this session as completed? This will trigger the AI summary for the student.",
      )
    )
      return;
    ...
    <div className="min-h-screen bg-[#111827] font-sans flex flex-col">
      <style>{`
        ...
        * { font-family: 'DM Sans', sans-serif; }
        ...
        .btn-end { background: #ef4444; transition: all 0.2s ease; }
      ...
      <nav className="bg-[#1f2937] border-b border-white/10 px-6 py-3 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="text-xs text-white/30 bg-white/10 px-2 py-0.5 rounded-lg">
              Mentor
            </span>
          </button>
        </div>
        <div className="flex items-center gap-3">
          ...
          {session?.status === "confirmed" && (
            <button
              ...
              className="btn-end text-white text-xs font-semibold px-4 py-2 rounded-xl"
            >
      ...
      <div className="flex-1 flex overflow-hidden">
              ...
              <div className="mb-3 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-white/40 text-xs">
                    Student: {studentName} · {session?.duration} min
                  </p>
                </div>
            ...
            <div className="w-full max-w-md card-animate">
              <div className="bg-[#1f2937] border border-white/10 rounded-3xl p-6 mb-4">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-2xl bg-emerald-500 flex items-center justify-center text-white font-bold text-lg sora">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-xs">Your Student</p>
                  </div>
                </div>
                <div className="space-y-3">
                  {[
                    { label: "Topic", value: session?.topic, icon: "📚" },
                    { label: "Goal", value: session?.learningGoal, icon: "🎯" },
                    {
                      label: "Date",
              ...
              <p className="text-white/30 text-xs text-center">
                💬 Chat with your student while waiting →
              </p>
            </div>
          )}
        </div>
        ...
        {/* Chat panel */}
        {canUseChat && showChat && (
          <div className="w-80 shrink-0 p-4 border-l border-white/10">
